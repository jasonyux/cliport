    ...
    while True:
        ...
        while collected < 120:
            ...
            for _ in range(task.max_steps):
                ...
                if done:
                    break
            if lang_goal in goals_collected:
                break
        ...
        # done 1000 experiments or is repeated
        goals_collected.add(lang_goal)
        print(f"Collected: {goals_collected}")
        if len(goals_collected) == 24:
            break
